...
const DESCRIPTION =
  'Proposta de presença digital para a Alvora Clean: Instagram, tráfego pago e perfil no Google, com planos mensais a partir de R$ 500.'
...
export default function Seo() {
  ...
  return (
    <Helmet htmlAttributes={{ lang: 'pt-BR' }}>
      ...
      <meta property="og:description" content="Instagram, tráfego pago e perfil no Google para a Alvora Clean. Planos a partir de R$ 500 por mês, sem fidelidade." />
