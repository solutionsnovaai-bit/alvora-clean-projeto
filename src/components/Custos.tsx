...
const FORA = [
  {
    ...
    titulo: 'Ferramentas',
    valor: 'cerca de R$ 100 por mês',
    texto: 'Domínio próprio, ferramenta de agendamento das publicações e banco de imagens. Fica no cartão de vocês, sem passar por mim.',
  },
  {
...
export default function Custos() {
  return (
    <Sheet tone="dark">
      <Container>
        <Heading
          title="O que não entra no meu valor."
          lead="Prefiro deixar claro agora: existem dois custos que são de vocês e que eu não recebo nada em cima."
        />
