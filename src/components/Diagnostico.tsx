...
const PONTOS: { icon: IconName; titulo: string; texto: string; estado: 'feito' | 'aberto' }[] = [
  {
    ...
    texto: 'Página completa no ar, com os serviços, a promoção de lançamento e botão de WhatsApp em todo lugar. Essa parte está resolvida.',
    estado: 'feito',
  },
  {
    icon: 'conversa',
    ...
    <Sheet id="diagnostico" tone="dark">
      <Container>
        <Heading
          ...
          lead="Antes de falar de preço, o retrato honesto da situação. Duas dessas três portas estão fechadas."
        />
