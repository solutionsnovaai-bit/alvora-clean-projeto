...
const QA: { q: string; a: ReactNode }[] = [
  ...
  { q: 'Quando o trabalho começa?', a: 'No dia em que o primeiro mês entra. A partir daí eu já começo a montagem do perfil e a produção dos primeiros criativos, que fazem parte do mesmo plano.' },
  { q: 'O site é cobrado à parte?', a: 'É. São R$ 300, uma vez só, na publicação. Já inclui colocar no ar, ligar o site ao Instagram, ao Google e ao WhatsApp, e os ajustes de texto e foto que vocês pedirem depois.' },
