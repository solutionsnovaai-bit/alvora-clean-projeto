...
export const PLANOS: Plano[] = [
  {
    ...
    total: 'R$ 500 + cerca de R$ 100 de ferramentas + a verba de anúncio',
  },
  {
    id: 'crescimento',
    nome: 'Crescimento',
    ...
    total: 'R$ 700 + cerca de R$ 100 de ferramentas + a verba de anúncio',
  },
  {
    id: 'constancia',
    nome: 'Constância',
    ...
    total: 'R$ 900 + cerca de R$ 100 de ferramentas + a verba de anúncio',
  },
]
